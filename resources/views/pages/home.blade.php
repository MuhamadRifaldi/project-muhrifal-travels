...
<main>
      ...
      <div class="section-pupolar-travel row justify-content-center">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="card-travel text-center d-flex flex-column" style="background-image: url('{{ $item->galleries->count() ? Storage::url
            ...
            <div class="trevel-country">{{ $item->location }}</div>
  ...
  <section class="section section-testimonial-content" id="tetimonialContent">
    <div class="container">
      <div class="section-pupular-travel row justify-content-center">
        <div class="col-sm-6 col-md-6 col-lg-4">
          <div class="card card-testimonial text-center">
            <div class="testimonial-content">
              <img src="frontend/images/1.png" alt="User" class="mb-4 rounded-circle">
        ...
        <div class="col-sm-6 col-md-6 col-lg-4">
          <div class="card card-testimonial text-center">
            <div class="testimonial-content">
              <img src="frontend/images/2.png" alt="User" class="mb-4 rounded-circle">
        ...
        <div class="col-sm-6 col-md-6 col-lg-4">
          <div class="card card-testimonial text-center">
            <div class="testimonial-content">
              <img src="frontend/images/3.png" alt="User" class="mb-4 rounded-circle">
              <h3 class="mb-4">Sherinna</h3>
              <p class="testimonial">
